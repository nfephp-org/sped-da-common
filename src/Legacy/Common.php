...
namespace NFePHP\DaCommon\Legacy;
...
class Common
{
     ...
     * 
     * @param  string $input Informação de data e tempo extraida da NFe
     * 
     * @return float UNIX timestamp Para uso com a funçao date do php
     */
    public function toTimestamp($input)
    {
        ...
        return \DataTime::createFromFormat("Y-m-d\TH:i:sP", $input)->getTimestamp();
    }
